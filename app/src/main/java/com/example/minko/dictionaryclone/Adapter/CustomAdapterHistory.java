...
public class CustomAdapterHistory extends ArrayAdapter<String> {
    ...
    public CustomAdapterHistory(ArrayList<String> data, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.imgFavor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbHistoryManager.deleteFavoriteByName(dataModel);
